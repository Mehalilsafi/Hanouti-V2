...
import { ArrowLeft, ArrowUpFromLine, SquarePen, Trash2, Search, Filter, Users, UserCheck, Heart, Plus } from "lucide-react";
      ...
      <div className="max-w-2xl md:max-w-4xl lg:max-w-6xl xl:max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
          <div>
            ...
            <p className="text-gray-600 text-sm mt-1">Manage and track your sales prospects</p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
            ...
            <div className="flex flex-wrap gap-2">
              {[
                ...
                { key: 'customer', label: 'Customers', icon: UserCheck, count: 89 },
            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-gray-50">
                  <TableHead className="font-semibold text-brand-primary">ID</TableHead>
                  <TableHead className="font-semibold text-brand-primary">Lead Information</TableHead>
                  <TableHead className="font-semibold text-brand-primary">Contact Details</TableHead>
                  <TableHead className="font-semibold text-brand-primary">Source</TableHead>
                  <TableHead className="font-semibold text-brand-primary">Status</TableHead>
                  <TableHead className="font-semibold text-brand-primary">Priority</TableHead>
          ...
          <div className="px-6 py-4 border-t border-gray-100 bg-gray-50">
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
              <p className="text-sm text-gray-600">
                Showing <span className="font-medium">1-3</span> of <span className="font-medium">156</span> leads
              </p>
              <div className="flex items-center gap-2">
