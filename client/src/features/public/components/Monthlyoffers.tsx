...
function Monthlyoffers() {
  ...
  return (
    // Overall container for the monthly offers section, ensuring consistent padding and centering
        ...
        {offersPrices.map((offer, index) => (
          ...
          >
            ...
            <CardContent className="flex flex-col items-center justify-center gap-2 mb-6">
              {/* Price display: Branded colors for currency and 'per month' */}
              <div className="flex items-baseline gap-1">
                ...
                <p className="text-base font-light text-brand-accent dark:text-brand-highlight">/month</p>
              </div>
